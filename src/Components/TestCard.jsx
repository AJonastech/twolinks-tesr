...
function TestCard() {
  ...
  return (
    <div style={{backgroundColor: theme.containerColor, color: theme.color, borderColor: theme.borderColor, borderWidth: "2px"}} className="w-full rounded-2xl flex flex-col border-2 min-h-[250px]">
      <div className="flex flex-col items-center px-5 py-9 ">
        ...
        <div className="flex mt-8 items-center justify-between w-full ">
            ...
            <button className="bg-blue px-4 py-1 rounded-md text-white">
                Start Test
            </button>
        </div>
      </div>
